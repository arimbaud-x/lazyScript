...
-- f frame
-----
local f = CreateFrame("SimpleHTML", nil, UIParent)
...
f:SetFont("H1", 'Fonts\\FRIZQT__.TTF', 16, "")
f:SetFont("P", 'Fonts\\FRIZQT__.TTF', 11, "")
f:SetTextColor(0, 0, 0)
f:SetTextColor("H1", 0, 0, 0)
f:SetTextColor("P", 0, 0, 0)
...
'<P><a href="myAction:doSomething">Click me</a></P>'
</body></html>
]])
f:Hide()
-----
